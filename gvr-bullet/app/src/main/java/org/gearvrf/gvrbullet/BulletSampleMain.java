...
public class BulletSampleMain extends GVRMain {
    ...
    private ArrayList<GVRSceneObject> sceneObjects = new ArrayList<GVRSceneObject>();
    ...
    public void onInit(GVRContext gvrContext) throws Throwable {
        ...
        mScene.setPhysicsWorld(new GVRPhysicsWorld(mGVRContext));
        ...
        groundScene.attachRigidBody(new GVRRigidBody(mGVRContext, 0, groundScene.getCollider(), groundScene.getTransform()));

        mScene.addSceneObject(groundScene);
        sceneObjects.add(groundScene);
        /*
    ...
    public void onStep() {
        Log.d("DEBUG" ,"ONSTEP");
        mScene.getPhysicsWorld().step(1.0f/60.0f);
        for(GVRSceneObject obj :  sceneObjects){
             obj.getTransform();
        }
    }
    ...
    private void addCube(GVRScene scene, float x, float y, float z, float mass) {
        ...
        cubeObject.attachRigidBody(new GVRRigidBody(mGVRContext, mass, cubeObject.getCollider(), cubeObject.getTransform()));

        scene.addSceneObject(cubeObject);
        sceneObjects.add(cubeObject);
    }
    ...
    private void addSphere(GVRScene scene, float radius, float x, float y,
        ...
        sphereObject.attachRigidBody(new GVRRigidBody(mGVRContext, mass, sphereObject.getCollider(), sphereObject.getTransform()));

        scene.addSceneObject(sphereObject);
        sceneObjects.add(sphereObject);
    }
